...
class StudentInformation {
     ...
     * @param      cat       The cat
     */
    StudentInformation(final String n, final String b, final int s1,
     ...
     * Comparator.
     */
    static Comparator<StudentInformation> comp = new Comparator<StudentInformation>() {
        public int compare(final StudentInformation s1, final StudentInformation s2) {
