...
public class LinearProbingHashST<Key, Value> {
   ...
   * { var_description }.
   */
  private int n;          // number of key-value pairs in
  /**
   * { var_description }.
   */
  ...
  // resizes the hash table to the given capacity by re-hashi.
  ...
  /**
   * Deletes the specified key (and its associated value) from this.
