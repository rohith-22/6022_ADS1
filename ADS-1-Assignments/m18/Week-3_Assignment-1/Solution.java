...
public final class Solution {
  ...
  public static void main(String[] args) {
    ...
    for (int j = 0; j < numberOfInputs; j++) {
      ...
      minPqObj1.insert(new StockExchange(tokens[0], Double.parseDouble(tokens[1])));
      maxPqObj1.insert(new StockExchange(tokens[0], Double.parseDouble(tokens[1])));
    }
    for (int i = 0; i < 5; i++) {
    ...
    for (int j = 0; j < numberOfInputs; j++) {
      String[] tokens = sc.nextLine().split(",");
      minPqObj2.insert(new StockExchange(tokens[0], Double.parseDouble(tokens[1])));
      maxPqObj2.insert(new StockExchange(tokens[0], Double.parseDouble(tokens[1])));
    }
    ...
    for (int j = 0; j < numberOfInputs; j++) {
      String[] tokens = sc.nextLine().split(",");
      minPqObj3.insert(new StockExchange(tokens[0], Double.parseDouble(tokens[1])));
      maxPqObj3.insert(new StockExchange(tokens[0], Double.parseDouble(tokens[1])));
    }
    for (int i = 0; i < 5; i++) {
    ...
    for (int j = 0; j < numberOfInputs; j++) {
      String[] tokens = sc.nextLine().split(",");
      minPqObj4.insert(new StockExchange(tokens[0], Double.parseDouble(tokens[1])));
      maxPqObj4.insert(new StockExchange(tokens[0], Double.parseDouble(tokens[1])));
    }
    for (int i = 0; i < 5; i++) {
...
/**
    ...
    for (int j = 0; j < numberOfInputs; j++) {
      String[] tokens = sc.nextLine().split(",");
      minPqObj5.insert(new StockExchange(tokens[0], Double.parseDouble(tokens[1])));
      maxPqObj5.insert(new StockExchange(tokens[0], Double.parseDouble(tokens[1])));
    }
    for (int i = 0; i < 5; i++) {
    ...
    for (int j = 0; j < numberOfInputs; j++) {
      String[] tokens = sc.nextLine().split(",");
      minPqObj6.insert(new StockExchange(tokens[0], Double.parseDouble(tokens[1])));
      maxPqObj6.insert(new StockExchange(tokens[0], Double.parseDouble(tokens[1])));
    }
    for (int i = 0; i < 5; i++) {
